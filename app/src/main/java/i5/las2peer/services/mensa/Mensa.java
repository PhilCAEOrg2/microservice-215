...
public class Mensa extends RESTService {
  ...
  @Api
  @SwaggerDefinition(
      info = @Info(title = "215", version = "0.0.0",
          description = "",
          termsOfService = "",
          contact = @Contact(name = "", email = "CAEAddress@gmail.com") ,
          license = @License(name = "BSD",
              url = "https://github.com/PhilCAEOrg2/microservice-215/blob/master/LICENSE.txt") ) )
  @Path("/")
  ...
  public Response getDishRatings(@PathParam("id") String id, String body) {
